...
app.view = function(vnode) {
  ...
  const saveOptions = event => {
    ...
    const userIdPromise = hasAuthParams
      ? state.gitlab
          .getCurrentUser({
    ...
    if (!state.gitlab.projects) {
      return m("tr", [
        m("td[colspan='6']", [
          m(".progress", [
            m(
              ".progress-bar.progress-bar-striped.active[aria-valuemax='100'][aria-valuemin='0'][aria-valuenow='100'][role='progressbar']",
              { style: { width: "100%" } },
    ...
    return state.gitlab.projects
      ...
      .map(project => {
        ...
        if (project.avatar_url) {
          ...
          names.push(
            m("img.icon.img-rounded[src='../img/gitlab_logo_128.png']")
          );
        }
        names.push(
          m(
            "a",
            { href: state.gitlab_path + project.path_with_namespace },
        ...
        return m("tr", [
          ...
          m("td.Commit", [
            m("input[type='checkbox']", {
              ...
              onclick: e => {
                project.events.Commit = e.target.checked;
              }
            })
          ]),
          m("td.Issue", [
            m("input[type='checkbox']", {
              ...
              onclick: e => {
                project.events.Issue = e.target.checked;
              }
            })
          ]),
          m("td.MergeRequest", [
            m("input[type='checkbox']", {
              ...
              onclick: e => {
                project.events.MergeRequest = e.target.checked;
              }
            })
          ]),
          m("td.Milestone", [
            m("input[type='checkbox']", {
              ...
              onclick: e => {
                project.events.Milestone = e.target.checked;
              }
            })
          ]),
          m("td", [
            m(
              "a.line-select-all[href='#']",
              {
                onclick: event => {
                  select_events(event, true);
                }
              },
              "+"
            ),
            " / ",
            m(
              "a.line-select-none[href='#']",
              {
                onclick: event => {
                  select_events(event, false);
                }
              },
              "-"
            )
  ...
  const quickSelectCol = column => {
    return [
      m(
        ...
        {
          onclick: event => {
            selectProject(event, column, true);
          }
        },
        "+"
      ),
      ...
      m(
        ...
        {
          onclick: event => {
            selectProject(event, column, false);
          }
        },
        "-"
      )
  ...
  return m("div", [
    m("h2", [m("i.fa.fa-gitlab[aria-hidden='true']"), "GitLab Setting"]),
    m(".form-horizontal[role='form']", [
      m(".form-group", [
        m("label.col-sm-3.control-label[for='gitlab_path']", "GitLab Path"),
        m(".col-sm-5", [
          m(
            "input.form-control[id='gitlab_path'][placeholder='http://example.com/'][type='text']",
            {
              value: state.gitlab_path,
              oninput: e => {
                state.gitlab_path = e.target.value;
              }
            }
          )
        ])
      ...
      m(".form-group", [
        ...
        m(".col-sm-5", [
          m(
            "input.form-control[id='api_path'][placeholder='http://example.com/api/v4/'][type='text']",
            {
              value: state.api_path,
              oninput: e => {
                state.api_path = e.target.value;
              }
            }
          )
        ])
      ...
      m(".form-group", [
        ...
        m(".col-sm-5", [
          m("input.form-control[id='private_token'][type='password']", {
            ...
            oninput: e => {
              state.private_token = e.target.value;
            }
          })
        ])
      ])
    ]),
    m("h2", [m("i.fa.fa-bell[aria-hidden='true']"), "Notification Setting"]),
    m(".form-horizontal[role='form']", [
      m(".form-group", [
        m(
          "label.col-sm-3.control-label[for='polling_second']",
          "Polling interval"
        ),
        m(".col-sm-5", [
          m("input.form-control[id='polling_second'][type='text']", {
            ...
            oninput: e => {
              state.polling_second = e.target.value;
            }
          }),
          m(
            "span.help-block",
            "Polling interval, in seconds. (Need chrome to restart)"
          )
        ])
      ]),
      m(".form-group", [
        m(
          "label.col-sm-3.control-label[for='max_event_count']",
        ...
        m(".col-sm-5", [
          m("input.form-control[id='max_event_count'][type='text']", {
            ...
            oninput: e => {
              state.max_event_count = e.target.value;
            }
          })
        ])
      ]),
      m(".form-group", [
        m(
          "label.col-sm-3.control-label[for='max_notification_count']",
        ...
        m(".col-sm-5", [
          m("input.form-control[id='max_notification_count'][type='text']", {
            ...
            oninput: e => {
              state.max_notification_count = e.target.value;
            }
          })
        ])
      ]),
      m(".form-group", [
        m(
          "label.col-sm-3.control-label[for='new_mark_minute']",
          "Mark event as new"
        ),
        m(".col-sm-5", [
          m("input.form-control[id='new_mark_minute'][type='text']", {
            ...
            oninput: e => {
              state.new_mark_minute = e.target.value;
            }
          }),
          m("span.help-block", [
      ...
      m(".form-group", [
        m(
          "label.col-sm-3.text-right[for='ignore_own_events']",
          "Ignore own events"
        ),
        m(".col-sm-5", [
          m("input[id='ignore_own_events'][type='checkbox']", {
            ...
            onclick: e => {
              state.ignore_own_events = e.target.checked;
            }
          })
        ])
      ])
    ...
    m("h2", [m("i.fa.fa-envelope[aria-hidden='true']"), "Repository Events"]),
    m("form.form-inline[role='form'].form-custom", [
      m(".form-group.col-xs-4", [
        m(".input-group", [
          m(".input-group-addon", [m("span.glyphicon.glyphicon-search")]),
          m(
            "input.form-control[id='search_repository'][placeholder='Project name'][type='text']",
            {
              oninput: e => {
                state.search_key = e.target.value;
              },
      ...
      m(
        ...
        [m("span.glyphicon.glyphicon-refresh"), "Refresh Repository List"]
      )
    ]),
